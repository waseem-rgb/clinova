...
import { createNewCase, getLastCase, patchCase, handoff as apiHandoff, getClientId, } from "../api/workspace";
// =============================================================================
// INITIAL STATE
// =============================================================================
const EMPTY_CONTEXT = {
...
export function WorkspaceProvider({ children }) {
    ...
    const updateOutputs = useCallback((updates) => {
    ...
    const performHandoff = useCallback(async (request) => {
        if (!state.caseId)
            return;
        dispatch({ type: "SAVE_START" });
        try {
...
export function useWorkspaceError() {
